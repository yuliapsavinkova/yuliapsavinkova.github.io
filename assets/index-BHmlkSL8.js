(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();const p={throttle:function(t,e){let n=0;return function(...s){const o=Date.now();o-n>=e&&(n=o,t.apply(this,s))}},debounce:function(t,e){let n;return function(...s){clearTimeout(n),n=setTimeout(()=>{t.apply(this,s)},e)}}};class b extends HTMLElement{connectedCallback(){this.innerHTML=`
    ...
    `}}customElements.define("section-header",L);const E="modulepreload",S=function(t){return"/"+t},m={},T=function(e,n,s){let o=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),c=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));o=Promise.allSettled(n.map(r=>{if(r=S(r),r in m)return;m[r]=!0;const d=r.endsWith(".css"),h=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${h}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":E,d||(l.as="script"),l.crossOrigin="",l.href=r,c&&l.setAttribute("nonce",c),document.head.appendChild(l),d)return new Promise((g,v)=>{l.addEventListener("load",g),l.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${r}`)))})}))}function a(i){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=i,window.dispatchEvent(c),!c.defaultPrevented)throw i}return o.then(i=>{for(const c of i||[])c.status==="rejected"&&a(c.reason);return e().catch(a)})};class C extends HTMLElement{connectedCallback(){this.innerHTML=this.getTemplate(),this.loadParticles()}getTemplate(){return`
    ...
    `}}customElements.define("expertise-component",H);class A extends HTMLElement{connectedCallback(){this.innerHTML=`
    ...
    `}}customElements.define("expertise-full-component",A);class P extends HTMLElement{constructor(){super(),this.innerHTML=`
        ...
        `}}customElements.define("about-component",P);class _ extends HTMLElement{connectedCallback(){this.innerHTML=`
    ...
    `,"/work":`
      ...
      <contact-component></contact-component>
    `,"/contact":"<contact-component></contact-component>","/profile/:id":s=>`<profile-component user-id="${s.id}"></profile-component>`},e=window.location.pathname,n=document.querySelector("main");for(const s in t){const o=new RegExp(`^${s.replace(/:\w+/g,"(\\w+)")}$`),a=e.match(o);if(a){const i=(s.match(/:(\w+)/g)||[]).map(r=>r.substring(1)),c=Object.fromEntries(i.map((r,d)=>[r,a[d+1]]));n.innerHTML=typeof t[s]=="function"?t[s](c):t[s],window.scrollTo({top:0,behavior:"smooth"});return}}n.innerHTML="<error-component></error-component>"}document.addEventListener("DOMContentLoaded",()=>{u(),window.addEventListener("popstate",u)});document.body.addEventListener("click",t=>{t.target.matches("a[href]:not([target])")&&(t.preventDefault(),history.pushState({},"",t.target.href),u())});
