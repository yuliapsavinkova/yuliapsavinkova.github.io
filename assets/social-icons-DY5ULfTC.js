class e extends HTMLElement{connectedCallback(){const a=this.getAttribute("mode")||"default";this.innerHTML=`
      <style>
        .social-icons {
          display: flex;
          align-items: center;
      ...
      <div class="social-icons mode-${a}">

        <a href="https://github.com/yuliapsavinkova"
           target="_blank" aria-label="GitHub" title="GitHub">
        ...
        <a href="https://codepen.io/star5/pens/public"
           target="_blank" aria-label="CodePen" title="CodePen">
        ...
        <a href="#" target="_blank" aria-label="Blog" title="Blog">
          <svg viewBox="0 0 512 512" fill="currentColor" aria-hidden="true">
    ...
    `}}customElements.define("social-icons",e);
