        ...
        <section id="expertise" class="section expertise">
            ...
            <div class="cards-container">
                <div class="card">
                    ...
                    <a href="../portfolio/work.html#work-row-web"><i class="fa-regular fa-circle-right fa-xl"></i></a>
                </div>
                <div class="card">
                    ...
                    <a href="../portfolio/work.html#work-row-app"><i class="fa-regular fa-circle-right fa-xl"></i></a>
                </div>
                <div class="card">
                    ...
                    <a href="../portfolio/work.html#work-row-3d"><i class="fa-regular fa-circle-right fa-xl"></i></a>
                </div>
            </div>
